...
#define LENCBUFFER 256
    ...
    */
    ...
    pSD->fbSnapActiveGC = NULL;
    pSD->fbSnapInactiveGC = NULL;
    pSD->fbSnapBgGC = NULL;
    pSD->fbSnapActiveColor = 0;
    pSD->fbSnapInactiveColor = 0;
    pSD->fbSnapBgColor = 0;
    pSD->fbLastX = -1;
    pSD->fbLastY = -1;
    pSD->fbLastWidth = -1;
    ...
    pSD->animateMinimizeRestore = False;
    pSD->showTaskSwitcher = False;
    pSD->taskSwitchWin = None;
